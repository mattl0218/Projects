...
class Neural_Network(object):
  ...
  def forward(self, X):
    ...
    o = self.tanh(self.z3) # updated activation function
    return o 
  ...
  def backward(self, X, y, o):
    # Backpropgate
    self.o_error = y - o 
    self.o_delta = self.o_error*self.tanh_derivative(o) 

    self.z2_error = self.o_delta.dot(self.W2.T) 
    self.z2_delta = self.z2_error*self.tanh_derivative(self.z2) 
